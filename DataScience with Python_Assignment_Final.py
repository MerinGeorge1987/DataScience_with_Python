...
Mhousing=pd.read_csv("E:/4. OT Domain Practice/Digital Technologist Training/Datascience with Python/melbourne-housing-market/Melbourne_housing_FULL.csv")
...
#Based on above correlation matrix, it can be concluded that
#     For Landsize, preferred transformation is LSsqrt  and
#     For BuildingArea, preferred transformation is logBA
Mhousing_num['LSsqrt']=np.sqrt(Mhousing_num['Landsize'])
Mhousing_num['logBA']=np.log(Mhousing_num['BuildingArea'])
